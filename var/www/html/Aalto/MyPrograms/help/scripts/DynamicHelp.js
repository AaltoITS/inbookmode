...
function DoDynamicHelpForMenuItem(dynHelp, objxml)
{
    ...
    if(value!=null)
    {
        //Start with MenuBrowser image
        var mbImage = getcurpath() + "\\mbicon.bmp"; 
        var mbHeader = "<img src=\"" + mbImage + "\">&nbsp;<span class=\"glyphArrow\"><img src=\"images\\ac.menuaro.gif\"></span>" ;
        ...
        if(defaultContent.childNodes != null)
        {
            ...
            if(indexOfFirstColon != -1)
            {
                ...
                result = mbHeader + result.replace(reDialogEllipses,"");
