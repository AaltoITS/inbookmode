...
<html lang="en">
    <title>Part | Aalto University</title>
...
<style type="text/css">
    ...
    .mce-branding-powered-by{
        ...
        display: none;
                    ...
                    <?php if((isset($part_details['id'])) && (!empty($part_details['id']))) {?>

                    <h1 class="page-title">Edit Part</h1><hr/>

                    <?php } else { ?>

                    <h1 class="page-title">Add New Part</h1><hr/>
    ...
    <?php if((!empty($this->session->flashdata('error_msg')))) {echo $this->session->flashdata('error_msg');} ?>
                    ...
                    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter Title Here" value="<?php if((isset($part_details['title'])) && (!empty($part_details['title']))) {echo $part_details['title'];} ?>" required>
                            <input type="hidden" name="db_title" value="<?php if((isset($part_details['title'])) && (!empty($part_details['title']))) {echo $part_details['title'];} ?>" >
                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                  ...
                                  <h4 class="panel-title">
                                    ...
                                    <a class="accordion-toggle" data-toggle="collapse" data-target="#Part-Text">
                                ...
                                <div id="Part-Text" class="collapse in">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="elm1" name="pageBody" style="line-height: 20px">
                                                ...
                                                <?php if((isset($part_details['content'])) && (!empty($part_details['content']))) {echo $part_details['content'];} ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="submit_btn" class="collapse in">
                                  ...
                                  <div class="panel-body" style="display: flex; align-items: center;justify-content: center;">
                                        ...
                                        <input type="submit" name="addpartSubmit" class="btn btn-primary" value="Save" style="width: 125px;">
