...
<html lang="en">
    <title>Frontmatter | Aalto University</title>
...
<style type="text/css">
    ...
    .mce-branding-powered-by{
        ...
        display: none;
                    ...
                    <?php if((isset($frontmatt_details['id'])) && (!empty($frontmatt_details['id']))) {?>

                    <h1 class="page-title">Edit Front Matter</h1><hr/>

                    <?php } else { ?>

                    <h1 class="page-title">Add New Front Matter</h1><hr/>
    ...
    <?php if((!empty($this->session->flashdata('error_msg')))) {echo $this->session->flashdata('error_msg');} ?>
                    ...
                    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter Title Here" value="<?php if((isset($frontmatt_details['title'])) && (!empty($frontmatt_details['title']))) {echo $frontmatt_details['title'];} ?>" required>
                            <input type="hidden" name="db_title" value="<?php if((isset($frontmatt_details['title'])) && (!empty($frontmatt_details['title']))) {echo $frontmatt_details['title'];} ?>" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                  ...
                                  <h4 class="panel-title">
                                    ...
                                    <a class="accordion-toggle" data-toggle="collapse" data-target="#FM-Text">
                                ...
                                <div id="FM-Text" class="collapse in">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="elm1" name="pageBody" style="line-height: 20px">
                                                ...
                                                <?php if((isset($frontmatt_details['content'])) && (!empty($frontmatt_details['content']))) {echo $frontmatt_details['content'];} ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="submit_btn" class="collapse in">
                                  ...
                                  <div class="panel-body" style="display: flex; align-items: center;justify-content: center;">
                                        ...
                                        <input type="submit" name="addfrontmatterSubmit" class="btn btn-primary" value="Save" style="width: 125px;">
